...
$keterangan_terlambat=0;
 ...
 if(isset($_GET['carinama'])){
   $cari_nama_siswa=$_GET['carinama'];
   $cari_bulan_siswa=$_GET['bulan'];
   $query_tampil=mysqli_query($konek,"select * from siswa where nama like '%$cari_nama_siswa%' ORDER BY nama");
 }else {
   // query tampil
   $query_tampil=mysqli_query($konek,"SELECT * FROM siswa ORDER BY nama ASC");
 }
 //end pencarian data
 ?>
 ...
 <div id="content">
   <div id="content-header">
     <div id="breadcrumb"> <a href="http://localhost/LMS/absensiswa/<?php echo $_SESSION['akses']; ?>/" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
       <a href="http://localhost/LMS/absensiswa/petugas_piket/siswa" class="tip-bottom">siswa</a><a href="#" class="current">Absen</a> </div>
     <h1>Absen siswa</h1>
   </div>
   <div class="container">
     <div class="span11">
