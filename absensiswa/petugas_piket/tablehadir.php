 ...
 <div id="content">
   <div id="content-header">
     <div id="breadcrumb"> <a href="http://localhost/LMS/absensiswa/<?php echo $_SESSION['akses']; ?>/" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
       <a href="http://localhost/LMS/absensiswa/petugas_piket/Hadir" class="tip-bottom">Kehadiran Guru</a> </div>
            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td><a href="http://localhost/LMS/absensiswa/petugas_piket/hadir/hapus/<?PHP echo $data['id']?>"class="btn btn-danger">Hapus</a></td>
                </tr>
                <?php $no++; } ?>
              </tbody>
            </table>
