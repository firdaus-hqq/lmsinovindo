<?php
 ...
 <div id="content-header">
   <div id="breadcrumb"> <a href="http://localhost/absensiswa/<?php echo $_SESSION['akses']; ?>/"
    title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
     <a href="http://localhost/absensiswa/admin/admin" class="tip-bottom">admin</a> <a href="#" class="current">Edit</a> </div>
   <h1>Edit Admin</h1>
 </div>
