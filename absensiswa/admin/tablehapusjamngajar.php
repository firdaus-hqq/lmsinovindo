...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="http://localhost/LMS/absensiswa/<?php echo $_SESSION['akses']; ?>/" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
      <a href="http://localhost/LMS/absensiswa/admin/jamngajar" class="top-bottom">Jam Ngajar</a><a href="#" class="current">Hapus</a> </div>
            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td><a href="http://localhost/LMS/absensiswa/admin/proses.php?hapus_jamngajar=<?PHP echo $data['id_jam_mengajar']?>"class="btn btn-info">Ya</a></td>
                  <td><a href="http://localhost/LMS/absensiswa/admin/wali"class="btn btn-danger">Tidak</a></td>
                </tr>
                <?php $no++; } ?>
              </tbody>
            </table>
