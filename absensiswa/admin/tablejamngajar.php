...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="http://localhost/absensiswa/<?php echo $_SESSION['akses']; ?>/" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
      <a href="http://localhost/absensiswa/admin/jamngaja" class="current">Jam Ngajar</a> </div>
            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td><a href="http://localhost/absensiswa/admin/jamngajar/edit/<?PHP echo $data['id_jam_mengajar']?>"class="btn btn-info">Edit</a></td>
                  <td><a href="http://localhost/absensiswa/admin/jamngajar/hapus/<?PHP echo $data['id_jam_mengajar']?>"class="btn btn-danger">Hapus</a></td>
                </tr>
                <?php $no++; } ?>
              </tbody>
            </table>
