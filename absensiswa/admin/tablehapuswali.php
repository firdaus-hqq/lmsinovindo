...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="http://localhost/absensiswa/<?php echo $_SESSION['akses']; ?>/" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
      <a href="http://localhost/absensiswa/admin/wali" class="tip-bottom"> Wali Kelas</a>
            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td><a href="http://localhost/absensiswa/admin/proses.php?hapus_wali=<?PHP echo $data['id_wali']?>"class="btn btn-info">Ya</a></td>
