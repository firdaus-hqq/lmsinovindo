<?php
 ...
 <div id="content-header">
   <div id="breadcrumb"> <a href="http://localhost/LMS/absensiswa/<?php echo $_SESSION['akses']; ?>/" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
     <a href="http://localhost/LMS/absensiswa/admin/jamngajar" class="tip-bottom">Jam Ngajar</a>
    <a href="http://localhost/LMS/absensiswa/admin/jamngajar/add" class="current">Tambah</a> </div>
