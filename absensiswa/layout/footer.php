...
<?php $actual_link = 'http://'.$_SERVER['HTTP_HOST'].$_SERVER['PHP_SELF'];
  if ($actual_link=="http://localhost/absensiswa/petugas_piket/index.php"
    or $actual_link=="http://localhost/absensiswa/kesiswaan/index.php"
    or $actual_link=="http://localhost/absensiswa/koordinator/index.php"
    or $actual_link=="http://localhost/absensiswa/wali_kelas/index.php") {
?>
...
<script src="http://localhost/absensiswa/js/jquery.flot.min.js"></script>
<script src="http://localhost/absensiswa/js/jquery.flot.resize.min.js"></script>
...
$(function () {
  ...
  if (isset($_SESSION['id_kelas'])) {
   ...
   ?>
    ...
    <?php if ($actual_link=="http://localhost/absensiswa/petugas_piket/index.php"
    or $actual_link=="http://localhost/absensiswa/koordinator/index.php") {?>
    var datasets2 = {
        "izin2": {
            label: "IZIN",
