...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="http://localhost/LMS/absensiswa/<?php echo $_SESSION['akses']; ?>/" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
      <a href="http://localhost/LMS/absensiswa/koordinator/laporan" class="tip-bottom">Guru</a> <a href="http://localhost/absensiswa/koordinator/laporan" class="current">Laporan Absen</a> </div>
