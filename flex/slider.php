...
<link href="<?PHP echo MY_PATH?>flex/css/style.css" rel="stylesheet" />
	...
	<!-- Slider -->
        <div id="main-slider" class="flexslider">
            <ul class="slides">
               <?php $tam=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT deskripsi,tgl_masuk,nama_prestasi,id_prestasi,gambar,nama_prestasiseo FROM v_prestasi ORDER BY rand() limit 4");
