                ...
                <i class='icon fa fa-check'></i> Success Patch database !!!.
                            ...
                            <div class='col-lg-3 col-md-6 col-xs-6'>
										...
										<p>SYNC</p>
                                                ...
                                                <a style="color:black;" href='sync-proses.php' class='small-box-footer'>
                                                  Syncronisasi <i class='fa fa-arrow-circle-right'></i>
                                                </a>
                                          </div>
                                        </div>
                            ...
                            <div class='col-lg-3 col-md-6 col-xs-6'>
										...
										<p>SYNC</p>
                                                ...
                                                <a style="color:black;" href='sync-proses2.php' class='small-box-footer'>
                                                  Syncronisasi <i class='fa fa-arrow-circle-right'></i>
                                                </a>
                                          </div>
                                        </div>
                            ...
                            <div class='col-lg-3 col-md-6 col-xs-6'>
										...
										<p>SYNC</p>
                                                ...
                                                <a style="color:black;" href='sync-proses3.php' class='small-box-footer'>
                                                  Syncronisasi <i class='fa fa-arrow-circle-right'></i>
                                                </a>
                                          </div>
                                        </div>  
