...
if($admin_su == 1)
				        ...
				        {
				             header('location:hasiltest.php?gagal=1');
				             exit;
				        }
?>
<!DOCTYPE html>
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="box-body">
                  <a href="hasiltest.php"><button type="button" class="btn btn-warning" data-toggle=""><i class="fa fa-angle-left"></i> Kembali</button></a>  
