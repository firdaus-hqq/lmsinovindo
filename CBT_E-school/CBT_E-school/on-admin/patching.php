    ...
    <i class="fa fa-refresh fa-spin" style="font-size:54px"></i>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><a href="#"> Home</a></li>
            <li><i class="fa fa-info-circle"></i> Patch Aplikasi</li>
          </ol>
        </section>
		...
		<div class="row">
			...
			<div class='col-lg-3 col-md-4 alert alert-success alert-dismissible fade-in'>
                ...
                <i class='icon fa fa-check'></i> Success Patch aplikasi !!!.
            </div>";
                            }}?>
					<?php
					$handle = fopen("https://smpn38sby.sch.id/update_cbtschool/patch-ver.txt", "rb");
					if (FALSE === $handle) {
				...
				$handle2 = fopen("versi/aktif/patch-ver.txt", "rb");
					if (FALSE === $handle2) {
						exit("Gagal terhubung dengan server pusat");
					}
					...
					if ($hasil > 0)
						{
										   ...
										   <div style="background-color:#e6eaf2;" class="alert alert-dismissible">
                                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                                <h5><i class="icon fa fa-info-circle"></i> New Patch available</h5><h4 style="color:red;"></h4>
                                                
                        <br>                      
                        <a style="float:left;" href="pre-patch.php?filer='.$contents.'">
						<button style="border-radius:30px;" class="btn btn-warning btn-flat"><i class="fa fa-download" aria-hidden="true"></i> Patch here</button></a>
                        </div>
                        <br><br>';
											}
					else 
						{
										   ...
										   <button class="btn btn-default btn-flat"><i class="fa fa-info-circle" aria-hidden="true"></i> No Patch available</button>
										   <br>
				';
					...
					<h4><font color='#FF0000'>Keterangan: *</font></h4>
                            <ul>
                            <li>Pastikan koneksi internet anda stabil ketika proses patching</li>
                            <br>
                            </ul>
							</div>
						</div>
