...
<script type="text/javascript">
  ...
  document.keypress = function (e) {
    if (e.ctrlKey && (e.which == 65 || e.which == 66 || e.which == 67 || e.which == 73 || e.which == 80 || e.which ==
        83 || e.which == 85 || e.which == 86)) {}
    return false
  }
</script>
...
<head>
  ...
  <style>
    ...
    #pagin li a:hover {
      background-image: url('mesin/pilblack.jpg') !important;
...
<body class="font-medium" style="background-color:#FFFFFF">
  <div class="container-fluid" style="width: 100%; height: 100%; overflow-y: scroll;">
        ...
        <div class="right">
          <table width="100%" border="0" cellspacing="5px;" style="margin-top:10px">
            <tbody>
              ...
              <tr>
                <td><span class="user">Dicky<br>smkn4</span></td>
              </tr>
              <tr>
                <td><span class="log"><a href="#">PPWB | 7854</a><span></span></span></td>
              </tr>
          </table>
        </div>
      </div>
    ...
    <div id="timer" class="list-group-item top-heading">
      ...
      <body onload=init() onunload=keluar()>
        <div class="btn-group" role="group" aria-label="Basic example">
          <button style="border-radius: 20px 0px 0px 20px;" id="btni" type="button" class="btn btn-danger"><b>SISA
              WAKTU</b> <i class="fa fa-clock-o fa-spin"></i></button>
          <button style="border-radius: 0px 20px 20px 0px;" type="button" class="btn btn-default"
            id="divwaktu"></button>
        </div>
      </body>
    </div>
    ...
    <div id="oket" class="resizer">
      <div class="btn-group" role="group" aria-label="Basic example">
        <button id="ket" type="button" class="btn btn-default"><b>Font Sizing : </b></button>
      ...
      <div class="list-group-item top-heading">
        <div class="divs">
          ...
          <div class="soalnye cls1">
            ...
            <!-------no soal------>
            <button id="nomer" type="button" class="soal btn-default"><b>1</b></button></br></br>
            <span class="resizable-content">
              ...
              <label id="ragu" class="btn btn-warning"><input type="checkbox" id="test1" value="supress">
                ...
                <span class='hidden-sm hidden-xs'><b>&emsp;&emsp;&emsp;&emsp;Tandai
                    Soal&emsp;&emsp;&emsp;&emsp;</b></span>
              </label>
            </span>
        ...
        <div id="garistom" class="list-group-item top-heading">
          <div class="tombol">
            <a id="prev">
              <button style="border-radius: 10px;" id="prev" class='btn btn-primary xxxx'>
            ...
            <a id="done"> <button style="border-radius: 10px;" id="done" class='btn btn-success xxxx'
                data-target='#ModalImport' data-toggle='modal' style="border-radius:0;"> <span
                  class='hidden-lg hidden-md'><i class='fa fa-check'></i> FINISH</span> <span
                  class='hidden-xs hidden-sm'><i class='fa fa-check'></i> Kumpulkan Ujian</span> </button></a>
            <a id="next">
  ...
  <div class="footer">
    <p>Ver. 1.0 Copyright &copy; 2021 IDMA </p>
  </div>
  </div>
  ...
  <div id="sidenav" class="sidenav">
    <div id="slidebtn" class="slideBtn">
      <div class="btn-group btn-group-md">
        <button style="border-radius: 10px;" id="hm" type="button" class="btnnav btn"><i class="fa fa-chevron-left"></i>
          <b>SOAL</b></button>
      </div>
    </div>
  ...
  <script type="text/javascript">
    ...
    function autosave() {
      ...
      var jawabansiswa = $("#jawabansiswa").val();
