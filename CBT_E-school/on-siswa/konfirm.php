                    ...
                    <div class="panel panel-default">
                        ...
                        <form action="start.php" method="post">
                            ...
                            <div id="garis" class="list-group-item">
                                ...
                                <h6><i>Baca dan centang beberapa syarat dibawah ini lalu klik mulai untuk mengerjakan soal !!!</i></h6>
                                </p>
                            </div>
                            <div id="garis" class="list-group-item top-heading">
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <h3>
                                                    <p>&emsp;&emsp;&emsp;&emsp;&emsp;اَللَّهُمَّ لاَ سَهْلَ إِلاَّ مَا جَعَلْتَهُ سَهْلاً وَأَنْتَ تَجْعَلُ الْحَزْنَ إِذَا شِئْتَ سَهْلاً</p>
                                                    <br>
                                                    <h5>Artinya :
                                                        <i>“Ya Allah! Tidak ada kemudahan kecuali apa yang Engkau jadikan mudah. Sedang yang susah bisa Engkau jadikan mudah, apabila Engkau menghendakinya.”</i>
                                                    </h5>
                                            </div>
