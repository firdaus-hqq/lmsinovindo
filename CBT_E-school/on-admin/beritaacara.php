    ...
    <div class="wrapper">
          ...
          <ul class="sidebar-menu" data-widget="tree">
        		...
        		<li class="treeview active">
                  ...
                  <ul class="treeview-menu">
    						...
    						<li class="active" id="sub"><a href="beritaacara.php"><i class="fa fa-print"></i><span> Berita Acara</span></a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Cetak Berita Acara</h1>
          <ol class="breadcrumb">
            <li><a href="#"> Home</a></li>
            <li><i class="fa fa-print"></i> Cetak Berita Acara</li>
          </ol>
        </section>
