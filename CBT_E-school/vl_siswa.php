...
$q = mysqli_query($GLOBALS["___mysqli_ston"], "select nis,password_login,nama_lengkap,statuslogin from siswa where BINARY nis='$username' and password_login='$password'");
if (mysqli_num_rows($q) == 1) {

$_SESSION['siswa'] = $username;
$_SESSION['nama_lengkap'] = $nama;
mysqli_query($GLOBALS["___mysqli_ston"], "update siswa set online='1'where nis='$username'");
