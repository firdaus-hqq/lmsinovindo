	...
	<div class="container">		
		<div class="row">			
			<div class="col-sm-7 sep">
				<div style='visibility: visible; animation-delay: 1s; animation-name: fadeInUp;' class='single_service wow fadeInUp animated' data-wow-delay='2s'>
				...
				<form method="post" role="form" id="form_login" action="adminku/cek_login.php">				
