...
if ($file_extension=='php'){
  echo "<h1>Access forbidden!</h1>
        ...
        Silahkan hubungi <a href='mailto:admin@rpl.smkti.sch.id'>webmaster</a>.</p>";
  exit;
}
else{
  mysqli_query($GLOBALS["___mysqli_ston"], "update file_materi set hits=hits+1 where nama_file='$filename'");
