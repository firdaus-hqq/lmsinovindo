...
$login_guru =mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM pengajar WHERE username_login='$username' AND password_login='$pass' AND blokir='N'");
...
if($ketemu_guru > 0){
  ...
  mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE pengajar SET id_session='$sid_baru' WHERE username_login='$username'");
