                                ...
                                <div class="table-responsive">
                                    <table id='example3' class='table table-bordered table-striped'>
                                        ...
                                        ?>
                                            ...
                                            <tbody>
                                                <?php
                                                $sql3 = "SELECT * FROM tugas WHERE id_siswa = '$data_tugas[id_siswa]'";
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button class="fa fa-check-circle" style="color:blue;" onclick="confirm('Yakin ingin konfirmasi tugas ini?') ? window.location.href='konfirmasi.php?id=<?= $tugas_siswa['id_file'] ?>':''"></button>
                                                            <!-- <i class="fa fa-times-circle" style="color:red;" onclick="confirm('Yakin ingin mengembalikan tugas ini?') ? window.location.href='delete.php?id_file=<?= $tugas['id_file'] ?>':''"></i></a>
