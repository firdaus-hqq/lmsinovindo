                    ...
                    <section class="content">
                        <div class='box box-warning'>
                            <div class='box-header with-border'>
                                <a href="v_bank_soal.php"><button id="clot" type="button" class="btn btn-default" data-toggle=""><i class="fa fa-angle-left"></i> Kembali ke Bank Soal</button></a>
                                <br><br>

                                <div id="printableArea">
                                    <table id="data5" class="table table-hover table-striped">
                                        <?php
                                        include "dt_edit_soal.php";
                                        ?>
                                    </table>
                                </div>
                            </div>
