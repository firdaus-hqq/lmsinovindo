...
$action = 'tambah_nilai.php';
if (!empty($peringkat)) $action = 'edit_typing_test.php?id_peringkat='.$peringkat['id_peringkat'];
                            ...
                            <div class='box-header with-border'>
                                <form action="<?= $action ?>" method="POST" class='form-horizontal form-groups-bordered'>
                                    <div class='col-md-12 col-xs-12'>
                                        ...
                                        <div class='form-group'>
                                            ...
                                            <select name='id_kelas' class='form-control'>
                                                ...
                                                <?php while ($sekolah = @$dataSekolah->fetch_array()) { ?>
                                                    <option value="<?php echo $sekolah['id_kelas'] ?>" <?php echo @$peringkat['id_kelas'] == $sekolah['id_kelas'] ? 'selected' : '' ?>>
                                        ...
                                        <div class='form-group'>
                                            <label>WPM</label>
                                            <input type='text' name='wpm' value="<?= @$peringkat['wpm'] ?>" class='form-control' id='field-1' required='required' placeholder='Isi WPM' />
                                        </div>
                                        <div class='form-group'>
                                            <label>Accuracy</label>
                                            <input type='text' name='accuracy' value="<?= @$peringkat['accuracy'] ?>" class='form-control' id='field-1' required='required' placeholder='Isi accuracy' />
                                        </div>
                                        <div class='form-group'>
                                            <input type='submit' class='btn btn-success' value='Simpan' style="margin-left: 5px;">
