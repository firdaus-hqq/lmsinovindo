                    ...
                    <section class="content">
                        <div class='box box-warning'>
                            <div class='box-header with-border'>
                                <p align='left'><a href='tambah_nilai.php' role='button' class='btn btn-warning'>Tambah Prestasi</a></p>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="edit_typing_test.php?id_peringkat=<?= $peringkat['id_peringkat']; ?>"><button class="btn btn-info">Edit</button></a>
                                                    <button class="btn btn-danger" onclick="confirm('Yakin ingin menghapus tugas ini?') ? window.location.href='delete_typing_test.php?id_peringkat=<?= $peringkat['id_peringkat'] ?>':''">Hapus</button></a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
