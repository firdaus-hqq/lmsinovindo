...
$query = mysqli_query ($mysqli, "SELECT * FROM soal CROSS JOIN jawaban USING (kodesoal) WHERE nis='$nis' ORDER by RAND ()");
						if($query == false){
...
$qq = mysqli_query ($mysqli, "SELECT * FROM profil where id='1'");
						if($qq == false){
							die ("Terjadi Kesalahan : ". mysqli_error($mysqli));
						}
