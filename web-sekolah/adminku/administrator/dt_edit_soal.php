    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="butirsoal_add.php" name="modal_popup" enctype="multipart/form-data" method="post">
                    <div class="form-group">
...
<tbody>
    <?php
    $querydosen = mysqli_query($mysqli, "SELECT * FROM soal where kodemapel='$mapel' and jenissoal='$jenis' and kodesoal='$kode'");
    if ($querydosen == false) {
    ...
    while ($ar = mysqli_fetch_array($querydosen)) {
        ...
        echo "
								<tr>
									...
									<a href='delete-butirsoal.php?id=$ar[id]'><button class='btn btn-danger'><i class='fa fa-trash-o'></i></button></a>
									</td>
								</tr>";
    }
    ?>
