...
$sql = "SELECT * FROM peringkat";
$result = $mysqli->query($sql);
if ($result->num_rows > 0) {
    $peringkat = $result->fetch_array();
} else {
    echo("ID Tidak ditemukan.");
}

$listDataNilai = $mysqli->query($sql);
                            ...
                            <div class='box-header with-border'>
                                ...
                                <table id='example1' class='table table-bordered table-striped'>
                                    ...
                                    <tbody>
                                        <?php 
                                        $i = 1;
                                        while ($peringkat = $listDataNilai->fetch_array()) {
                                        ?>
                                            <tr>
                                                <td><?= $i++ ?></td>
                                                <td><?= $peringkat['id_siswa'] ?></td>
                                                <td><?= $peringkat['id_kelas'] ?></td>
                                                <td><?= $peringkat['pretest'] ?></td>
                                                <td><?= $peringkat['posttest'] ?></td>
                                                <td></td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
