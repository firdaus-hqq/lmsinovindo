      ...
      <div class="box box-info">
        ...
        <div class="box-body">
          ...
          <table class="table table-striped">
             ...
             <tbody><?php $ber=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT nama_berita,pembuat,dibaca,id_berita FROM berita ORDER BY id_berita DESC limit 5");
            while ($r=mysqli_fetch_array($ber)) {
              ?>
      ...
      <div class="box box-danger">
        ...
        <div class="box-body">
          <table class="table table-striped"> <tbody>
            <?php $ber=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM file_materi ORDER BY id_file DESC limit 5");
            while ($r=mysqli_fetch_array($ber)) {
              ?>
    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
      <div class="info-box">
        ...
        <div class="info-box-content">
          ...
          <span class="info-box-number"><?php
 $tam=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT COUNT(id) AS JUMLAH FROM mata_pelajaran");
 $r=mysqli_fetch_array($tam);
 $tot=$r['JUMLAH']; { ?>
                <span><?php echo $tot; ?></span>
                <?php  
    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
      <div class="info-box">
        ...
        <div class="info-box-content">
          ...
          <span class="info-box-number"><?php
 $tam=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT COUNT(id_pengajar) AS JUMLAH FROM pengajar");
 $r=mysqli_fetch_array($tam);
 $tot=$r['JUMLAH']; { ?>
                <span><?php echo $tot; ?></span>
                <?php 
      ...
      <div class="box box-danger">
        ...
        <div class="box-body">
          ...
          <table class="table table-striped">
             ...
             <tbody><?php $ber=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT nama_prestasi,pembuat,dibaca,id_prestasi FROM prestasi ORDER BY id_prestasi DESC limit 5");
            while ($r=mysqli_fetch_array($ber)) {
              ?>
     ...
     <div class="col-md-6 col-sm-6 col-xs-6">
      <div class="box box-warning">
        ...
        <div class="box-body">
          ...
          <?php
          $sql=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM registrasi_siswa ORDER BY id_registrasi limit 8");
           $no=1;
