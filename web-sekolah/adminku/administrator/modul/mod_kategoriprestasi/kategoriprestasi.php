...
switch($_GET[act]){
         ...
         <p><a href='javascript:;' onclick=\"jQuery('#modal-6').modal('show', {backdrop: 'static',value:'$id'});\" class='btn btn-warning'>Tambah Kategori</a></p>
               ...
               <br/>
                        ...
                        <table class='table table-bordered table-striped table-condensed cf'>
                            ...
                            <tbody>"; 
    $tampil=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM kategori_prestasi ORDER BY id_kategoriprestasi DESC");
    $no=1;
  ...
  // Form Edit Kategori  
  case "editkategori":
    $edit=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM kategori_prestasi WHERE id_kategoriprestasi='$_GET[id]'");
