...
if ($module=='berita' AND $act=='hapus'){
  $data=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT gambar FROM berita WHERE id_berita='$_GET[id]'"));
  if ($data['gambar']!=''){
...
elseif ($module=='berita' AND $act=='input'){
  ...
  if (!empty($lokasi_file)){
    ...
    mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO berita(nama_berita,
                                    nama_beritaseo,
                                    id_kategori,
                                    keyword,
                                    deskripsi,
...
elseif ($module=='berita' AND $act=='update'){
 ...
 $namaberita_seo = seo_title($_POST['nama_berita']);
  ...
  if (empty($lokasi_file)){
    mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE berita SET nama_berita = '$_POST[nama_berita]',
