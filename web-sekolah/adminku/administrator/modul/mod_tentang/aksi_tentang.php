...
if ($module=='tentang' AND $act=='hapus'){
  $data=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT gambar FROM tentang  WHERE id_tentang='$_GET[id]'"));
  if ($data['gambar']!=''){
     mysqli_query($GLOBALS["___mysqli_ston"], "DELETE FROM tentang WHERE id_tentang='$_GET[id]'");
  ...
  mysqli_query($GLOBALS["___mysqli_ston"], "DELETE FROM berita WHERE id_berita='$_GET[id]'");
  header('location:../../media_admin.php?module='.$module);
}
// Input produk
elseif ($module=='tentang' AND $act=='input'){
  ...
  if (!empty($lokasi_file)){
    ...
    mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO tentang(judul, 
                                    deskripsi,
                                    gambar) 
                            VALUES('$_POST[judul]',
                                   '$_POST[deskripsi]',
...
elseif ($module=='tentang' AND $act=='update'){
  ...
  if (empty($lokasi_file)){
    mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE tentang SET judul = '$_POST[judul]',                       
