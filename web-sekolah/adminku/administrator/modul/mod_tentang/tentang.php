    ...
    echo "<div class='box box-warning'>
        <div class='box-header with-border'>
                       <table class='table table-bordered table-striped table-condensed cf'>
                            ...
                            <tbody> ";
    $tampil = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM tentang ORDER BY id_tentang DESC");
    $no = $posisi+1;
...
<input type='text' name='judul' class='form-control' id='field-1' required='required' placeholder='Placeholder'/>
     ...
     break;    
  case "edittentang":
    $edit = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM tentang WHERE id_tentang='$_GET[id]'");
