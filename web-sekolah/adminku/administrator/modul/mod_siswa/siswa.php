  ...
  switch ($_GET['act']) {
    ...
    default:
      if ($_SESSION['leveluser'] == 'admin') {
        ...
        $tampil_siswa = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM siswa ORDER BY id_kelas");
...
<div class='box box-warning'>
        ...
        $tampil = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT nis,nama_lengkap,alamat,tempat_lahir,tgl_lahir,id_kelas,tgl_masuk,tgl_keluar,no_telp,jenis_kelamin FROM siswa");
...
";
  ...
  ";
   ...
   <table  id='example1' class='table table-bordered table-striped'>
    ...
    case "editsiswa":
      $edit = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM siswa WHERE id_siswa='$_GET[id]'");
...
<input type=text name='nama' value='$r[nama_lengkap]' class='form-control' required='required' id='nama' placeholder='Placeholder' size=70></div></div>
  ...
  <div class='col-sm-5'><input class='form-control' required='required' id='field-1' placeholder='Placeholder' type='text' name='tempat_lahir' size=80 value='$r[tempat_lahir]'></div>
          ...
          <div class='col-sm-2'>
          <label>Tanggal Lahir</label></div><div class='col-sm-5'>
          <input type='date' name='tgl_lahir' value='$r[tgl_lahir]' class='form-control' id='field-1' required='required' placeholder='Tanggal Lahir'>";
          // $get_tgl = substr("$r[tgl_lahir]", 8, 2);
          // combotgl(1, 31, 'tgl', $get_tgl);
          // $get_bln = substr("$r[tgl_lahir]", 5, 2);
          // combonamabln(1, 12, 'bln', $get_bln);
