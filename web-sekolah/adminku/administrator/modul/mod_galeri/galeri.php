        ...
        <div class='box-header with-border'>
         <p align='left'><a href='javascript:;' onclick=\"jQuery('#modal-6').modal('show', {backdrop: 'static'});\" class='btn btn-warning'>Tambah Kategori</a></p>
                       <table   id='example1' class='table table-bordered table-striped'>					
                            ...
                            <tbody> ";
    $tampil = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM galeri_foto ORDER BY id_galerifoto DESC");
    $no = $posisi+1;
...
<br/>
    ...
    break;
  case "editgaleri":
    $edit = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM galeri_foto WHERE id_galerifoto='$_GET[id]'");
