...
if ($module=='prestasi' AND $act=='hapus'){
  ...
  if ($data['gambar']!=''){
     mysqli_query($GLOBALS["___mysqli_ston"], "DELETE FROM prestasi WHERE id_prestasi='$_GET[id]'");
...
elseif ($module=='prestasi' AND $act=='input'){
  ...
  if (!empty($lokasi_file)){
    ...
    mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO prestasi(nama_prestasi,
                                    nama_prestasiseo,
                                    id_kategoriprestasi,
                                    keyword,
                                    deskripsi,
...
elseif ($module=='prestasi' AND $act=='update'){
 ...
 $namaprestasi_seo = seo_title($_POST['nama_prestasi']);
  ...
  if (empty($lokasi_file)){
    mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE prestasi SET nama_prestasi = '$_POST[nama_prestasi]',
