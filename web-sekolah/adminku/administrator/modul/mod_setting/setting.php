...
switch($_GET[act]){
    ...
    echo "<div class='box box-warning'>
        <div class='box-header with-border'>
                       ...
                       <table  id='example1' class='table table-bordered table-striped'>
                            ...
                            <tbody> ";
    $tampil = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM setting ORDER BY id_setting DESC");
    $no = $posisi+1;
  ...
  case "editsetting":
    $edit = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM setting WHERE id_setting='$_GET[id]'");
