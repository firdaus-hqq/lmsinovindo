...
if ($module=='modul' AND $act=='hapus'){
  mysqli_query($GLOBALS["___mysqli_ston"], "DELETE FROM modul WHERE id_modul='$_GET[id]'");
...
elseif ($module=='modul' AND $act=='update'){
  mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE modul SET nama_modul = '$_POST[nama_modul]',
                                link       = '$_POST[link]',
