...
if (!empty($_POST['nis']) AND !empty($_POST['email'])){
    ...
    mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO registrasi_siswa(nis,nama_lengkap,id_kelas,alamat,tempat_lahir,tgl_lahir,jenis_kelamin,agama,nama_ayah,
