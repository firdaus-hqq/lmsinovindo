...
include ('fungsi.php');
// mysqli_query($GLOBALS["___mysqli_ston"], "update siswa set statuslogin='1'where nis='$nis'");
$query = mysqli_query ($mysqli, "SELECT * FROM soal CROSS JOIN jawaban USING (kodesoal) WHERE nis='$username' ORDER by RAND ()");
						if($query == false){
    ...
    <div class="group">
        ...
        <?php }?>
    	    <div class="right">
				...
				<tr><td><span class="log"><a href="#"><?php echo $codesoal; ?></a><span></span></span></td></tr>
			    </table>
            </div>
    </div>
</header>
...
<?php
    include "scriptsoal.php";
    include "ragu_script.php";
?>
</body>
