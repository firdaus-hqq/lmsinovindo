...
error_reporting(0);
 include "config/config.php";
     include "adminku/configurasi/fungsi_indotgl.php"; ?>
      ...
      <?php                  $id = mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_GET['prestasi']);    
						$sql=mysqli_query($GLOBALS["___mysqli_ston"], "select * from v_prestasi where nama_prestasiseo='$id'");
...
<section class="breadcrumb">
	<div class="container">
		<div class="row">
			<div class="col-sm-12">
				<h1><?php  
				$id = mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_GET['prestasi']); 
						$sql=mysqli_query($GLOBALS["___mysqli_ston"], "select * from v_prestasi where nama_prestasiseo='$id'");
				...
				<li class="active">
							<strong><?php
							$id = mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_GET['prestasi']);
						$sql=mysqli_query($GLOBALS["___mysqli_ston"], "select nama_katprestasi from v_prestasi where nama_prestasiseo='$id' ");
						while($s=mysqli_fetch_array($sql)){
						?>
					...
					<li class="active">
							<strong><?php
							$id = mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_GET['prestasi']);
						$sql=mysqli_query($GLOBALS["___mysqli_ston"], "select nama_prestasi from v_prestasi where nama_prestasiseo='$id'");
						while($s=mysqli_fetch_array($sql)){
						?>
						<?php echo $s['nama_prestasi'];?> 
						<?php } ?>
		...
		<div class="row">
			<div class="col-sm-11">
				<div class="blog-post-single">
					<?php
					$id = mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_GET['prestasi']);
					$update=mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE  prestasi SET dibaca=dibaca+1  WHERE nama_prestasiseo='$id'"); ?>
					<?php $id = mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_GET['prestasi']);
							$sql=mysqli_query($GLOBALS["___mysqli_ston"], "select * from v_prestasi where nama_prestasiseo='$id'");
						while($s=mysqli_fetch_array($sql)){
          ...
          <button class='btn btn-primary pull-right' onclick=kirim($s[id_prestasi])>Input</button>
				...
				<hr/>	
					...
					<hr/>
						...
						<?php 
						$artikel=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT tgl_masuk,id_prestasi,nama_prestasi,nama_katprestasi,gambar,nama_prestasiseo From v_prestasi ORDER BY rand() DESC limit 4");
