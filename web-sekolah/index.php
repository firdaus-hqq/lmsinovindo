  ...
  <div class="section" id="populer">
            ...
            <div class="container">
                <div class="row" style="text-align: center">
                 ...
                 <?php  $ber=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT id_berita,nama_berita,gambar,nama_kat,tgl_masuk,nama_beritaseo,pembuat,deskripsi FROM v_berita ORDER BY dibaca DESC limit 4");
			...
			<div class="client-logos carousel slide" data-ride="carousel" data-interval="5000">
				<div class="carousel-inner">
					<div class="item active">
						<?php
						$galeri=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT gambar FROM v_kategori_foto ORDER BY id_galerifoto DESC limit 4");
					...
					<div class="item">
							<?php
						$galeri=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT gambar FROM v_kategori_foto ORDER BY id_galerifoto ASC limit 4");
						while($r=mysqli_fetch_array($galeri)){
							?>
							<?php echo "<a href='#''>
							<img src='adminku/foto_galeri/medium_$r[gambar]'  class='img-rounded'> </a>"; ?>
