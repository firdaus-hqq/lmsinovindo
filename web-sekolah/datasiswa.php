...
<section class="gallery-container">
 ...
 <div class='container'>
		...
		<hr/>
			...
			<tbody>
				<?php 
			$sql=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM v_siswa Where id_kelas='10rpl' ");
    ...
    <td>$jurusan</td>
			...
			<tbody>
				<?php 
			$sql=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM v_siswa Where id_kelas='11rpl'  ");
			 while ($r=mysqli_fetch_array($sql)){
	$nis = $r['nis'];
	$nama = $r['nama_lengkap'];
	$al= $r['alamat'];
    ...
    <td>$jurusan</td>
			...
			<tbody>
				<?php 
			$sql=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM v_siswa Where id_kelas='12rpl' ");
			 while ($r=mysqli_fetch_array($sql)){
	$nis = $r['nis'];
	$nama = $r['nama_lengkap'];
	$al= $r['alamat'];
