...
include "config/config.php";
     ...
     <?php                  $id = mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_GET['news']);    
						$sql=mysqli_query($GLOBALS["___mysqli_ston"], "select * from v_berita where nama_beritaseo='$id'");
...
<section class="breadcrumb">
	<div class="container">
		<div class="row">
			<div class="col-sm-12">
				<h1><?php 
				$id = mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_GET['news']);  
						$sql=mysqli_query($GLOBALS["___mysqli_ston"], "select * from v_berita where nama_beritaseo='$id'");
		...
		<div class="row">
			<div class="col-sm-11">
				<div class="blog-post-single">
					<?php
					$id = mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_GET['news']);
					$update=mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE  berita SET dibaca=dibaca+1  WHERE nama_beritaseo='$id'"); 
          ...
          <button class='btn btn-primary pull-right' onclick=kirim($s[id_berita])>Input</button>
				...
				<hr/>	
					...
					<hr/>
						...
						<?php 
						$artikel=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * From v_berita ORDER BY rand() DESC limit 4");
